...
namespace Sarak.Models.Views
{
    public class ProductGroupView:BaseModel
    {
        #region Properties
        ...
        public virtual ProductGroupView Parent { get; set; }
        public virtual ICollection<ProductGroupView> Childs { get; set; }
        public virtual ICollection<ProductGroupView> Products { get; set; }
